...
#
# gen-dispatch depends only on gen-prelude.
#
...
# pin source; no library code reads it any more. The one dependency is a root input of the root
# lock, so its path below is one segment.
#
